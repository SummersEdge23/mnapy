...
from pysolver import DividerLimits
...
class Divider:
    def __init__(
        ...
        self.option_limits = DividerLimits.DividerLimits(
    ...
    def update(self) -> None:
        ...
        if (
            ...
            if self.Input_Voltage2 != 0:
                self.Output_Voltage = self.Input_Voltage1 / self.Input_Voltage2
            else:
                self.Output_Voltage = 0
    ...
    def stamp(self) -> None:
        ...
        self.context.stamp_voltage(
            ...
            -1,
            self.Output_Voltage,
            self.context.ELEMENT_DIV_OFFSET + self.SimulationId,
        )
